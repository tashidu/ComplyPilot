...
export function SmartFixView({
  ...
  const approved = invoiceFinding?.status === "resolved";
      ...
      {smartFix.status === "NO_INVOICE" ? (
        ...
        <>
          ...
          <SectionHead
            ...
            aside={
              <button className="button small primary" onClick={onApprove} disabled={approved}>
                {approved ? "Draft approved" : "Approve corrected draft"}
              </button>
            }
          />
                ...
                <article className="card pad" key={action.field}>
                  ...
                  <div className="smartfix-diff">
                    ...
                    <div>
                      ...
                      <strong>
                        {action.suggestedValue === null ? "Awaiting human input" : formatValue(action.suggestedValue)}
                      </strong>
                    </div>
                  </div>
                  <p>{action.reason}</p>
